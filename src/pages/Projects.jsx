...
import { ExternalLink, Cpu, Calendar, Users, CheckCircle, Clock, Star } from "lucide-react"

export default function ProjectsPage() {
  const [mousePosition, setMousePosition] = useState({ x: 0, y: 0 })
  const [activeTab, setActiveTab] = useState("completed")
  const [completedFilter, setCompletedFilter] = useState("all") // all, beginner, intermediate
  ...
  const allProjects = [
    {
      ...
      title: "Virtual Piano",
      description:
        "A virtual piano using Arduino UNO R3 that produces different musical notes based on the distance of fingertips from an ultrasonic sensor.",
      image:
    ...
    },
    {
      ...
      title: "BT Speaker",
      description:
        "ESP32 Bluetooth Audio Receiver with OLED Display that receives audio via Bluetooth A2DP and displays song metadata.",
      image:
        "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHJvYm90aWNzfGVufDB8fDB8fHww",
      category: "audio",
    ...
    },
    {
      ...
      image:
        "https://media.istockphoto.com/id/1500558452/photo/component-installation-on-circuit-board-fully-automated-modern-pcb-assembly-line-equipped.webp?a=1&b=1&s=612x612&w=0&k=20&c=xabzrpEHdMnQ7TfxUUv1DHj02ouPjr4kjIIKBL2ZrC4=",
      category: "IoT",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGVsZWN0cm9uaWNzfGVufDB8fDB8fHww",
      category: "health",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1517420704952-d9f39e95b43e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGVsZWN0cm9uaWNzfGVufDB8fDB8fHww",
      category: "game",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1558137623-ce933996c730?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHJvYm90aWNzfGVufDB8fDB8fHww",
    ...
    },
    {
      ...
      image:
        "https://media.istockphoto.com/id/858053178/photo/digital-electronic-components-circuit-boards-technology-era-india-map.webp?a=1&b=1&s=612x612&w=0&k=20&c=n4BOC6wGjp9Hs7hw119PksFB-x8dHn7jY3e6wgl5PfI=",
      category: "electronics",
      members: [
        "prabhat sati",
        "himesh jha",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24 py-12 relative z-10 pt-24">
        ...
        {/* Difficulty Filter for Completed Projects */}
        {activeTab === "completed" && (
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            <button
              ...
              className={`px-4 py-2 rounded-full border text-sm transition-all duration-300 ${
                completedFilter === "all"
                  ? "bg-cyan-500/20 border-cyan-400 text-cyan-400"
                  : "bg-gray-800/30 border-gray-600 text-gray-400 hover:border-cyan-400/50"
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-4 py-2 rounded-full border text-sm transition-all duration-300 ${
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">{getSectionTitle()}</h2>
          <p className="text-gray-400">{getSectionDescription()}</p>
        </div>
...
function ProjectCard({ project }) {
  ...
  const handleViewDetails = (e) => {
    ...
    try {
      ...
      // Fallback: you could show an alert or handle the error differently
  ...
  const getDifficultyBadge = () => {
    if (project.difficulty === "beginner") {
      return (
        <div className="absolute top-3 left-3 bg-green-500/80 backdrop-blur-md px-2 py-1 rounded-full text-xs font-medium text-white flex items-center gap-1">
          <Star className="h-3 w-3" />
          Beginner
        </div>
      )
    ...
    if (project.difficulty === "intermediate") {
      return (
        <div className="absolute top-3 left-3 bg-orange-500/80 backdrop-blur-md px-2 py-1 rounded-full text-xs font-medium text-white flex items-center gap-1">
          <Star className="h-3 w-3" />
          <Star className="h-3 w-3" />
          Intermediate
        </div>
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: isHovered ? "0 12px 30px rgba(0,255,255,0.25)" : "0 6px 16px rgba(0,0,0,0.25)",
      ...
      >
        ...
        <div className="p-5">
          ...
          <button
            ...
            className="inline-flex items-center font-medium text-sm hover:underline transition-colors duration-200 hover:text-cyan-400"
            style={{ color: "white" }}
          >
