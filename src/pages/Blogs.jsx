  ...
  useEffect(() => {
    ...
    const fetchBlogsFromGoogleSheets = async () => {
      try {
        ...
        const googleSheetUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQwGh9D-94lYn9qZNmFwk1vH0kur3kDzCmekA9a0Zv9tauA94SOGDp5ikxQtbthydk9IVyZTAHR-oMe/pub?output=csv';
        ...
        setBlogs([
          {
            ...
            description: "Learn how to build a complete IoT weather station using Arduino, sensors, and cloud connectivity to monitor environmental conditions in real-time.",
          ...
          },
          {
            ...
            description: "Master the fundamentals of PCB design with these industry-standard best practices that will improve your circuit reliability and manufacturing success rate.",
          ...
          },
          {
            ...
            description: "Dive into the world of Field Programmable Gate Arrays and learn how to implement custom digital logic for high-performance computing applications.",
          ...
          },
          {
            ...
            description: "A comprehensive guide to preparing for and competing in collegiate robotics competitions, with tips from our award-winning team members.",
          ...
          },
          {
            ...
            description: "Explore the critical security vulnerabilities in embedded systems and learn practical techniques to protect your IoT devices from common attacks.",
          ...
          },
          {
            ...
            description: "Implement TinyML models on resource-constrained microcontrollers to create smart, efficient edge computing solutions for real-world problems.",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white">
      ...
      <div className="relative pt-16 pb-10 px-4 sm:px-6 lg:px-8">
        <section className="pt-20 text-center">
          ...
          >
            <h1 className="text-cyan-400 text-4xl md:text-6xl font-bold">
              Our Blog
            </h1>
            <p className="text-xl mt-8 text-gray-300 max-w-3xl mx-auto">
              Deep dives, practical guides, and fresh perspectives-crafted to
              fuel your curiosity and creativity in electronics and technology.
            </p>
          </motion.div>
...
const BlogCard = ({ title, description, imageUrl, mediumUrl, category, author, date, readTime, index }) => {
  ...
  return (
    <motion.div
      ...
      className="h-[450px] relative group"
    >
      <motion.a
        href={mediumUrl}
        target="_blank"
      ...
      >
        ...
        >
          <h2 className="text-2xl font-bold mb-3 text-white leading-tight">{title}</h2>
