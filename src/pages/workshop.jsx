...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQmDYzV-CpQGWVFBHiGyHWLz5Qmfbpn8t_rOtgmvRMZr_93Z5LyDfJUoHplgxa2pdaL4MUtWwba4L1q/pub?output=csv';
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#0a1828] via-[#10172a] to-[#1a2235] p-8">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-cyan-200">📅 Upcoming Workshops</h2>
          {loading ? (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {upcomingWorkshops.length === 0 ? (
                ...
                upcomingWorkshops.map((workshop) => (
                  ...
                  >
                    <h3 className="text-xl font-bold text-cyan-300">{workshop.title}</h3>
        ...
        {/* Previous Workshops */}
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-cyan-200">📜 Previous Workshops</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {previousWorkshops.map((workshop) => (
              ...
              >
                <h3 className="text-xl font-bold text-cyan-200">{workshop.title}</h3>
